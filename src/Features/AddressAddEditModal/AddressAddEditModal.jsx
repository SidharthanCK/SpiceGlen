...
function AddressAddEditModal({ open, onClose }) {
  if (!open) return null;
  return (
    <div>
      {/* Address Add modal */}
        <div className="fixed inset-0 z-50  backdrop-blur-sm bg-transparent  flex justify-center items-center ">
      <div className="bg-white  max-w-xl max-h-[80vh] overflow-y-auto rounded-lg shadow-lg p-6 relative mt-30">
        {/* Header */}
        <div className="flex justify-between items-start mb-4">
          <div>
            <h2 className="text-2xl font-semibold text-gray-800">Add Address</h2> 
            <p className="text-sm text-gray-500">Add your delivery address</p>
          </div>
