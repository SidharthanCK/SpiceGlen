...
function Footer() {
  return (
    <div>
       <footer className="bg-[#637C5A] text-white px-6 py-10">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between">
        ...
        <div className="md:w-1/3 mb-10 md:mb-0">
          ...
          <p className="text-sm mt-4 leading-relaxed">
            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque a erat in urna
            hendrerit efficitur in sed nulla. Sed venenatis nunc sed sem lacinia consequat
          </p>
